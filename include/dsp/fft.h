...
smp_t dsp_rfft_err(dsp_rfft_t *fft);

void dsp_rfft_fft(const dsp_rfft_t *fft, const smp_t *x, cpx_t *X);
void dsp_rfft_ifft(const dsp_rfft_t *fft, const cpx_t *X, smp_t *x);
